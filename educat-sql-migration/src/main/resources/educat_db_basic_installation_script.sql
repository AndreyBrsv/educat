...
CREATE TABLE EC_USERS (
    ...
    USER_ROLE_ID NUMERIC(2, 0) NOT NULL,
    ...
    REGISTRATION_DATE TIMESTAMP WITH TIME ZONE DEFAULT timenow()
);
...
CREATE TABLE EC_ADDITIONAL_USER_REFERENCES (
    ADDITIONAL_USER_REFERENCE_ID NUMERIC(19, 0) PRIMARY KEY,
...
CREATE TABLE EC_USER_ROLES (
    USER_ROLE_ID NUMERIC(100, 0) PRIMARY KEY,
...
CREATE TABLE EC_USER_PERMISSIONS (
    USER_PERMISSION_ID NUMERIC(4, 0) PRIMARY KEY,
...
CREATE TABLE EC_ROLE_PERMISSION_REFERENCES (
    USER_ROLE_ID NUMERIC(2, 0) NOT NULL,
    USER_PERMISSION_ID NUMERIC(4, 0) NOT NULL,
...
CREATE TABLE EC_USER_TO_USER_SUBSCRIPTIONS (
    SUBSCRIBE_USER_ID NUMERIC(19, 0) NOT NULL,
    SUBSCRIBED_USER_ID NUMERIC (19, 0) NOT NULL,
